...
import com.skuu.common.enums.ICode;
import com.skuu.common.exception.BizException;
...
public abstract class AssertUtil {
	...
	public static void isTrue(boolean expression, ICode message) {
		if (!expression) {
	...
	public static void isNull(@Nullable Object object, ICode message) {
		if (object != null) {
			throw new BizException(message);
		}
	}
	...
	public static void notNull(@Nullable Object object, ICode message) {
		if (object == null) {
			throw new BizException(message);
		}
	}
	...
	public static void hasLength(@Nullable String text, ICode message) {
		if (!StringUtils.hasLength(text)) {
			throw new BizException(message);
		}
	}
	...
	public static void hasText(@Nullable String text, ICode message) {
		if (!StringUtils.hasText(text)) {
			throw new BizException(message);
		}
	}
	...
	public static void notEmpty(@Nullable Object[] array, ICode message) {
		if (ObjectUtils.isEmpty(array)) {
			throw new BizException(message);
		}
	}
	...
	public static void noNullElements(@Nullable Object[] array, ICode message) {
		if (array != null) {
			for (Object element : array) {
				if (element == null) {
					throw new BizException(message);
	...
	public static void notEmpty(@Nullable Collection<?> collection, ICode message) {
		if (CollectionUtils.isEmpty(collection)) {
			throw new BizException(message);
		}
	}
	...
	public static void noNullElements(@Nullable Collection<?> collection, ICode message) {
		if (collection != null) {
			for (Object element : collection) {
				if (element == null) {
					throw new BizException(message);
